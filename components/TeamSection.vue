            ...
            <div class="row">
                <div class="col-lg-8 m-auto">
                    <div class="section-title text-center" data-aos="fade-up" data-aos-duration="1000">
                        <h2 class="title">Tenaga Pendidik</h2>
                        ...
                        <div class="desc">
                            <p class="mt-21">Sebagai institusi pendidikan , Imavi memiliki tenaga pendidik yang berkompeten<br></p>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    export default {
        ...
        async fetch () {
            ...
            this.featureddosen = payload.featuredLecturers
            console.log(this.featuredDosen);
