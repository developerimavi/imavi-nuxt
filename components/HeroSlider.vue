        ...
        <div class="home-slider-content">
            <div class="home-slider-container">
                <swiper :options="swiperOptions">
                    <!-- Start Slide Item -->
                    <div class="swiper-slide home-slider-item" :style="{ backgroundColor : 'white' }">
                        <div class="slider-content-area" style="margin-top:0px; align-items: flex-start;">
                            <div class="content">
                                <div class="tittle-wrp" style="color">
                                    <h2>IMAVI</h2>
                                </div>
                                <p style="color : #fd9704 ; font-family : Apple Chancery">Institut Teologi milik Keuskupan Surabaya yang berpegang pada Ajaran Gereja Katolik untuk memberikan pendidikan Teologi kepada para calon imam, awam dan religius. Sebagai Institut Teologi, Imavi bergerak pada pengembangan Pastoral, Katekese dan Liturgi.</p>
                            ...
                            <div class="layer-style">
                                <div class="thumb">
                                    <img src="/images/imavi/landing1.png" alt="Images">
                                </div>
                                <div class="success-rate">
                                    <div class="content" style="padding:0px">
                                        <img src='/images/imavi/logo-imavi.png'>
                                    </div>
                                </div>
